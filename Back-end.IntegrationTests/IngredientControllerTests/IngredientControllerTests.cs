...
//COMMENTED SINCE GROUP H DOESN'T HAVE ENDPOINT FOR INGREDIENT CONTROLLERS
...
//         {
//             await AuthenticateAsync();
//             var hersheyList = new List<IngredientDto> { new IngredientDto { id = 1, name = "Hershey Dark Chocolate" } }.Select(x => x);
...
//         {
//             await AuthenticateAsync();
//             var chocolateList = new List<IngredientDto> { new IngredientDto { id = 1, name = "Hershey Dark Chocolate" },
//                  new IngredientDto { id = 2, name = "Cadbury Milky Chocolate" },
//                  new IngredientDto { id = 3, name = "Lindt White Chocolate" } }.Select(x => x);
